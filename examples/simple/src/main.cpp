...
public:
    ...
    void update() override
    {
        ...
        //        strokeWeight(10);
        //        stroke(255, 0, 0);
        //        vector(sin(second() / 60.0 * 2 * PI) * 200, -cos(second() / 60.0 * 2 *
        //        PI) * 200, width / 2, height / 2); stroke(0, 255, 0);
        //        vector(sin(minute() / 60.0 * 2 * PI) * 200, -cos(minute() / 60.0 * 2 *
        //        PI) * 200, width / 2, height / 2); stroke(0, 0, 255); vector(sin(hour()
        //        / 12.0 * 2 * PI) * 200, -cos(hour() / 12.0 * 2 * PI) * 200, width / 2,
        //        height / 2); println("Mouse: {}, {}", mouseX, mouseY);
